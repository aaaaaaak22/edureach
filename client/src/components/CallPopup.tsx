...
export default function CallPopup({ open, onClose }: CallPopupProps) {
 ...
 // const [phone, setPhone] = useState("");
  ...
  const handleError = (error: unknown) => {
    ...
    setStatus("error");
    toast.error("Vapi voice call failed.");
  };
  ...
  <div className="text-center py-10">
    ...
    <p className="text-gray-500 text-sm mb-5">
      Your AI counselor is connecting through your browser.
    </p>
          ...
          {status === "done" && (
            <div className="text-center py-10">
              ...
              {/* <p className="text-gray-500 text-sm mb-4">You'll receive a call shortly on {phone}.</p> */}
               <p className="text-gray-500 text-sm mb-4">You'll receive a call shortly on .</p>
